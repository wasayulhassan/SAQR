...
const SAQR_TRANSLATIONS = {
  en: {
    ...
    report_generating: "Building your Word report…",
    chat_export_ready_msg: "Here's that as a Word document.",
    ppt_h1: "PowerPoint",
  ...
  ar: {
    ...
    report_generating: "جارٍ إعداد تقرير Word الخاص بك…",
    chat_export_ready_msg: "إليك ذلك كمستند Word.",
    ppt_h1: "بوربوينت",
  ...
  ur: {
    ...
    report_generating: "آپ کی Word رپورٹ تیار کی جا رہی ہے…",
    chat_export_ready_msg: "یہ رہا وہ Word دستاویز کے طور پر۔",
    ppt_h1: "پاورپوائنٹ",
  ...
  hi: {
    ...
    report_generating: "आपकी Word रिपोर्ट तैयार की जा रही है…",
    chat_export_ready_msg: "यह रहा वह Word दस्तावेज़ के रूप में।",
    ppt_h1: "पावरपॉइंट",
